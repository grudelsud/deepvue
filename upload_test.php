...
<form id="form1" name="form1" enctype="multipart/form-data" method="post" action="upload_remote.php">
	<table>
		...
		<tr>
			...
			<td><input name="time" type="text" id="time" value="2010-09-18 15:30:00 GMT 2" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input name="time_start" type="text" id="time_start" value="2010-09-18 15:00:00 GMT 2" /></td>
		</tr>
		<tr>
			...
			<td><input name="time_end" type="text" id="time_end" value="2010-09-18 16:00:00 GMT 2" /></td>
		</tr>
		<tr>
