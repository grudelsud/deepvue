...
$_SESSION['user_id'] = 2;
$_SESSION['user_login'] = "grudelsud";
$_SESSION['real_name'] = "Tom";
$_SESSION['oauth_id'] = 36017645;
...
<html>
<head>
<title>DeepVue Alpha | Login Tom</title>
...
echo "<h3><br>&nbsp; You are now logged in as Tom.</h3>";	
