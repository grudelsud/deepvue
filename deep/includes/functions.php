...
function send_authcode( $login, $auth, $email ) {
	...
	$message .= "* The app interface is pretty simple: tap on the torch icon to turn it on and off, tap on the privacy button to set your present moment as private or public, gently touch the viewfinder to capture (or just aim and wait for the auto capture).\n";
	...
	$message .= "* DeepVue shares the moment every about 30 minutes (or for every event).\n";
